...
generate-check:
	GOWORK=off go run ./cmd/logcopter-gen -area-prefix lib.ble -strip-prefix github.com/go-go-golems/logcopter/examples/library-prefix -check ./examples/library-prefix/...
